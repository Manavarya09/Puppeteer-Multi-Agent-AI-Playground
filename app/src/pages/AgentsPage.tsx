    ...
    <div className="max-w-[1400px] mx-auto px-6 py-16">
      <div className="grid grid-cols-12 gap-8 mb-16">
        ...
        <div className="col-span-12 md:col-span-5 self-end text-[15px] text-bone-300/85 leading-relaxed">
          ...
          The orchestrator picks among them step-by-step using a learned policy. Custom agents are
          available on the Teams tier — they slot into the same invocation surface.
        </div>
      </div>
      ...
      <div className="mt-20 border hairline p-8">
        <div className="grid grid-cols-12 gap-6 items-center">
          <div className="col-span-12 md:col-span-7">
            ...
            <p className="text-[14px] text-bone-300/85 mt-2 max-w-prose">Teams users can publish a custom agent in under ten minutes. The orchestrator re-evaluates its policy and starts routing to the new agent within minutes of deployment.</p>
          </div>
          <div className="col-span-12 md:col-span-5 md:text-right">
            <Link to="/playground" className="inline-block px-5 py-3 bg-signal-amber text-ink-950 font-mono text-[12px] tracking-[0.22em] uppercase hover:bg-bone-100 transition-colors">Try in the playground →</Link>
          </div>
        </div>
      </div>
    </div>
