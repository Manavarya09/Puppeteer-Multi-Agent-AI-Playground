...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        ink: {
          950: '#08080a', 900: '#0c0c0e', 850: '#101013', 800: '#15151a',
          700: '#1c1c22', 600: '#26262e', 500: '#3a3a44', 400: '#5b5b66', 300: '#8a8a92',
        },
        bone: {
          50: '#fdfaf2', 100: '#f6f1e6', 200: '#ebe4d2', 300: '#d3cab4', 400: '#9a9382',
        },
        signal: {
          amber: '#f5b942', ember: '#e07a3c', sage: '#8aa67a', rust: '#c64a3a',
        },
      },
      fontFamily: {
